...
const FilterButtons = ({ handleAllFilter, setQuery }) => {
 return (
  <div className="filter-container">
   <div className="filter-button1">
    <button onClick={handleAllFilter} type="button" className="btn btn-primary">ALL {" "}
   ...
   <div className="filter-button2">
    <button onClick={() => setQuery('2017')} type="button" className="btn btn-primary">2017</button>
   </div>
